...
| Cassandra     | Хранение данных                      |           |
| Redis         | Хранение данных, сессий пользователя |           |
| Kafka         |                                      |           |
| ElasticSearch | Поиск                                |           |
| S3            | Хранение данных                      |           |
| Tarantool     | Хранение данных                      |           |
| CDN           | Быстрая раздача статики              |           |
| Envoy         |                                      |           |
...
| ---------- | ---------------------------------------------- | --------- |
| Go         | Backend                                        |           |
| Python     | Вычисления и обработка данных ML               |           |
| TypeScript | Frontend                                       |           |
| Kotlin     | Мобильное приложение (Android)                 |           |
| Swift      | Мобильное приложение (iOS)                     |           |
| Vue        | Frontend                                       |           |
| gRPC       | Вызов методов удалённых серверов               |           |
| Protobuf   | Протокол сериализации структурированных данных |           |
...
| Docker     | Контейнеризация приложений и их окружения |           |
| GitLab CI  | CI/CD                                     |           |
