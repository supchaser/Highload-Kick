...
- обслуживать одинаковое среднее кол-во DAU: 3.6 млн / 32 = 112500 пользователей
- иметь одинаковое кол-во RPS: 315/32 = 9.84 ~ 10. Тогда пиковый RPS, который может приходиться на один ДЦ: 10 \* 2 = 20.
